...
import { Box, Button, FormControl, FormLabel, Input, Text, Alert, AlertIcon, AlertDescription, Heading, Stack, Image, ButtonGroup } from "@chakra-ui/react";
...
function SignupPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateEmail(email) && validatePasswords()) {
      console.log("Signup attempt with:", email, userType);
      navigate('/login');
    }
  };
